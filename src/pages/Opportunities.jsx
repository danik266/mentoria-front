  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="relative mb-6">
        <Icon
          name="search"
          className="text-[22px] absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500"
        />
        <input
          value={query}
...
function DetailsModal({ op, onClose, onToggleSave }) {
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-slate-900 w-full sm:max-w-lg rounded-t-3xl sm:rounded-3xl shadow-2xl max-h-[90vh] overflow-y-auto"
      ...
      >
        <div className="p-6 sm:p-8">
          ...
          <h2 className="text-2xl font-extrabold text-slate-800 dark:text-white mb-3">{op.title}</h2>
